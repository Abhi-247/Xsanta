  ...
  const services = [
    {
      ...
      description: "Build comprehensive automotive marketplaces for buying, selling, and trading vehicles with advanced search and listings."
    },
    {
      icon: <MapPin className="w-12 h-12" />,
      title: "Fleet Management Systems",
      description: "Real-time vehicle tracking, maintenance scheduling, driver management, and fuel optimization for fleet operations."
    },
    {
      icon: "🔧",
      title: "Service & Parts Management",
      description: "Complete solutions for auto repair shops, parts inventory, appointment booking, and customer service management."
    },
    {
      icon: <Settings className="w-12 h-12" />,
      title: "Connected Car Solutions",
      description: "IoT-enabled vehicle diagnostics, telematics, predictive maintenance, and in-vehicle infotainment systems."
    }
  ];

  const technologies = [
    { icon: "🚗", name: "IoT Sensors", type: "Hardware" },
    { icon: "📍", name: "GPS Tracking", type: "Location" },
    { icon: "📱", name: "Mobile Apps", type: "Frontend" },
    { icon: "🤖", name: "AI Diagnostics", type: "Analytics" },
    { icon: "☁️", name: "Cloud", type: "Infrastructure" },
    { icon: "📊", name: "Telematics", type: "Data" },
  ...
  const process = [
    {
      ...
      description: "Understand your automotive business model, operational challenges, and digital transformation goals."
    },
    {
      number: "02",
      title: "Solution Architecture",
      description: "Design custom platforms with vehicle management, IoT integration, and customer-facing applications."
    },
    {
      number: "03",
      title: "Development & Integration",
      description: "Build robust systems with GPS tracking, payment gateways, and third-party automotive APIs."
    },
    {
      number: "04",
      title: "Deploy & Support",
      description: "Launch your automotive platform and provide continuous maintenance, updates, and technical support."
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Live vehicle location, speed, and route monitoring"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Secure Systems",
      description: "Data encryption and secure payment processing"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Driver & Customer Apps",
      description: "Mobile applications for all stakeholders"
    },
    {
      icon: <Star className="w-8 h-8" />,
      title: "Predictive Analytics",
      description: "AI-powered maintenance and performance insights"
    }
  ];
      ...
      <section className="relative bg-gradient-to-br from-purple-50 via-pink-50 to-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pb-12">
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
            {["IoT Connected", "Real-Time Tracking", "AI-Powered"].map((feature, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Our <span className="bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">Automotive Solutions</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive technology solutions for the automotive industry
            </p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Advanced automotive technology stack for modern solutions
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-purple-50 via-pink-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A proven methodology for automotive digital transformation
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 leading-relaxed">
            Let's build intelligent automotive solutions that drive efficiency and growth
          </p>
