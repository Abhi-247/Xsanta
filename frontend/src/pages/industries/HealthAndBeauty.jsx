...
import { Heart, Zap, Shield, Users, CheckCircle, ArrowRight, ChevronRight, Star, Sparkles, Calendar } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Smart scheduling platforms for salons, spas, and wellness centers with automated reminders and calendar integration."
    },
    {
      icon: <Heart className="w-12 h-12" />,
      title: "E-commerce Solutions",
      description: "Beautiful online stores for beauty products, supplements, and wellness items with subscription management."
    },
    {
      icon: "💆",
      title: "Customer Management",
      description: "CRM systems to track client preferences, treatment history, product purchases, and personalized recommendations."
    },
    {
      icon: <Sparkles className="w-12 h-12" />,
      title: "Virtual Consultations",
      description: "Telehealth and virtual beauty consultation platforms with video calls, AR try-on, and AI skin analysis."
    }
  ];

  const technologies = [
    { icon: "💅", name: "Booking APIs", type: "Scheduling" },
    { icon: "🛍️", name: "E-commerce", type: "Platform" },
    { icon: "📱", name: "Mobile Apps", type: "Frontend" },
    { icon: "🤖", name: "AI/AR", type: "Technology" },
    { icon: "💳", name: "Payments", type: "Integration" },
    { icon: "📊", name: "Analytics", type: "Insights" },
    { icon: "📧", name: "Marketing", type: "Automation" },
  ...
  const process = [
    {
      ...
      description: "Understand your brand values, target audience, and unique positioning in the beauty and wellness market."
    },
    {
      number: "02",
      title: "Experience Design",
      description: "Create stunning, intuitive interfaces that reflect your brand's aesthetic and enhance user experience."
    },
    {
      number: "03",
      title: "Development & Integration",
      description: "Build custom solutions with booking systems, e-commerce, payment gateways, and marketing tools."
    },
    {
      number: "04",
      title: "Launch & Growth",
      description: "Deploy your platform and provide ongoing optimization, marketing support, and feature enhancements."
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Stunning visuals that capture the essence of beauty and wellness"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "HIPAA Compliant",
      description: "Secure systems that protect sensitive health and customer data"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Client-Focused",
      description: "Features that enhance customer experience and loyalty"
    },
    {
      icon: <Star className="w-8 h-8" />,
      title: "Mobile-First",
      description: "Responsive design optimized for on-the-go bookings and purchases"
    }
  ];
      ...
      <section className="relative bg-gradient-to-br from-purple-50 via-pink-50 to-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-600 leading-relaxed">
              Transform your beauty and wellness business with elegant digital solutions for bookings, e-commerce, customer management, and virtual consultations.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-6 pb-12">
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
            {["Elegant Design", "Easy Booking", "Secure & Compliant"].map((feature, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Our <span className="bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">Beauty & Wellness Solutions</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Digital platforms designed specifically for the beauty and wellness industry
            </p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Advanced tech stack for modern beauty and wellness businesses
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-purple-50 via-pink-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From concept to a thriving digital beauty platform
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 leading-relaxed">
            Let's build a stunning digital platform that attracts clients and grows your wellness brand
          </p>
