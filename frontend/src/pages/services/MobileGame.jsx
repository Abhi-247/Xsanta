...
import { Gamepad2, Trophy, Users, Zap, CheckCircle, ArrowRight, ChevronRight, Sparkles, Target, Rocket, Star } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Addictive, easy-to-play games with engaging mechanics designed for mass appeal and viral growth potential."
    },
    {
      icon: "🎮",
      title: "Action & Adventure Games",
      description: "Immersive gameplay experiences with stunning graphics, compelling storylines, and thrilling game mechanics."
    },
    {
      icon: "🧩",
      title: "Puzzle & Strategy Games",
      description: "Brain-teasing challenges and strategic gameplay that keep players engaged for hours with progressive difficulty."
    },
    {
      icon: <Trophy className="w-12 h-12" />,
      title: "Multiplayer & Social Games",
      description: "Connected gaming experiences with real-time multiplayer, leaderboards, and social features for player retention."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Brainstorm game mechanics, create concept art, design characters, and develop engaging gameplay loops."
    },
    {
      number: "02",
      title: "Prototyping",
      description: "Build playable prototypes to test core mechanics, gameplay balance, and player engagement before full development."
    },
    {
      number: "03",
      title: "Full Development",
      description: "Implement all features, levels, graphics, animations, sound effects, and monetization strategies."
    },
    {
      number: "04",
      title: "Testing & Launch",
      description: "Rigorous QA testing, beta releases, bug fixes, and successful launch on App Store and Google Play."
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Beautiful 2D/3D graphics optimized for mobile devices"
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Smooth Performance",
      description: "60fps gameplay on wide range of devices"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Multiplayer Ready",
      description: "Real-time multiplayer and social features"
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Monetization",
      description: "IAP, ads, and reward systems integration"
    }
  ];
  ...
  const whyChoose = [
    {
      ...
      description: "We create games that players love with addictive mechanics and engaging content.",
      stat: "4.5+"
    },
    {
      icon: "📱",
      title: "Games Launched",
      description: "Successfully developed and launched mobile games across various genres.",
      stat: "50+"
    },
    {
      icon: "👥",
      title: "Million Downloads",
      description: "Our games have been downloaded and enjoyed by players worldwide.",
      stat: "10M+"
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-600 leading-relaxed">
              Create captivating mobile games that players can't put down. From casual to hardcore, we build immersive gaming experiences for iOS and Android.
            </p>
          ...
          {/* Floating Game Icons */}
          <div className="hidden lg:block absolute right-20 top-20 animate-bounce" style={{ animationDuration: '3s' }}>
            <div className="text-7xl">🎮</div>
          </div>
          <div className="hidden lg:block absolute right-40 bottom-32 animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              End-to-end mobile game development for every genre and platform
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-purple-50 via-pink-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expertise across all popular mobile game genres
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-purple-50 via-pink-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry-leading game engines and development tools
            </p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From concept to launch - bringing your game vision to life
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 md:p-12 rounded-2xl shadow-xl border-2 border-purple-200">
            ...
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed mb-8 italic text-center">
              "XSANTA transformed our game idea into reality. The attention to detail, smooth gameplay, and engaging mechanics exceeded our expectations. Our game hit 1 million downloads in just 3 months!"
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">CEO, GameStudio Inc.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
            Ready to Create the Next Hit Game?
          </h2>
          <p className="text-xl text-purple-100 mb-8 leading-relaxed">
            Let's build an engaging mobile game that players will love and can't stop playing
          </p>
